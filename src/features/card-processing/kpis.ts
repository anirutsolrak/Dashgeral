...
export const KPI_META: Record<WorkflowKpi, { title: string; detailsTitle: string; area: string }> =
  {
    integration: {
      ...
      detailsTitle: 'Taxa de Integração - Detalhamento',
      area: 'Operações',
    },
    accounts: {
      title: 'Contas Criadas',
      detailsTitle: 'Contas Criadas e Não Criadas - Detalhamento',
      area: 'Criação de Contas',
    },
    cards: {
      title: 'Cartões Enviados',
      detailsTitle: 'Cartões Enviados - Detalhamento',
      area: 'Envio de Cartões',
    },
    insurance: {
      title: 'Propostas com Seguro',
      detailsTitle: 'Propostas com Seguro - Detalhamento',
      area: 'Seguros',
    },
  }
